...
%   [model,optimal] = kfold_cv(EEG,BOLD,...) performs non-dependent, nested 
%   k-fold cross val to obtain the best model for the input EEG, BOLD data
%   Pararelled computing version. Inner loop is also nondependent
%
%   Input data:
%
%     EEG              The model's X 
...
% compute the set of 20 best rho-lambda pairs for 
% the a random set of the size of the train set and
% and use these for all the train/test sets. This is
